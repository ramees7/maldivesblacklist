...
export default function GettingMoneyBack({ gettingMoneyBack }) {
  ...
  return (
    <div>
      <div className="gap-y-8 pb-8">
        ...
        (d) Getting my money back
        </h2>

        <div>
          {gettingMoneyBack.map((faq, index) => (
            <div
              key={index}
            ...
            >
              <button
                ...
                className="accordion-header py-5 w-full gap-x-4 flex justify-between items-center text-left text-gray-700 px-10 text-xl"
              >
                <div>
