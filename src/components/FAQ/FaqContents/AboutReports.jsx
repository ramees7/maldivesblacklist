...
//         <h2 className="text-4xl leading-9 font-semibold mb-16 text-[#000080]">
//           (a) About my report
//         </h2>
...
//                 className="accordion-header py-5 w-full flex justify-between items-center text-left text-[#000] px-10 text-xl"
//               >
//                 <div>
